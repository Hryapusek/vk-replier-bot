...
from messageprocessing.commands.set_gym_status import GYM_STATUS_FILE
...
class GymCommand(ICommand):
    def handle(self, event: VkBotMessageEvent) -> None:
        ...
        response_message = read_from_file(GYM_FILE)
        response_message += "\n\nТекущий статус: "
        response_message += read_from_file(GYM_STATUS_FILE)
